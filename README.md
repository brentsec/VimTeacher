...
![VimTeacher Demo](docs/static/vimteacher-demo.gif)
...
2. Add `"your_lesson"` to the appropriate section in the `M.sections` table in `lua/vimteacher/lessons/init.lua`
