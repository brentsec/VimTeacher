...
assert_test(
	delete_inside_brackets.type == "insert",
	"type must be 'insert', got " .. tostring(delete_inside_brackets.type)
)
...
assert_test(
	#delete_inside_brackets.allowed_keys == 0,
	"allowed_keys must be empty, got " .. #delete_inside_brackets.allowed_keys
)
...
counter.finish("test_delete_inside_brackets")
