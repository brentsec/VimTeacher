...
assert_test(#window_scrolls.sandbox_snippet >= 10, "sandbox_snippet must have 10+ lines for scrolling, got " .. #window_scrolls.sandbox_snippet)
...
assert_test(desc_text:lower():find("ctrl+d") ~= nil or desc_text:lower():find("ctrl%+d") ~= nil, "Description should mention 'Ctrl+d'")
assert_test(desc_text:lower():find("ctrl+u") ~= nil or desc_text:lower():find("ctrl%+u") ~= nil, "Description should mention 'Ctrl+u'")
...
assert_test(challenge.snippet_lines ~= window_scrolls.sandbox_snippet, "snippet_lines should not be same reference as sandbox_snippet")
...
-- Summary
print(string.format("test_window_scrolls: %d passed, %d failed (total: %d assertions)",
