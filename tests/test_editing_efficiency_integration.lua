...
local function run_repeat_power_case(case)
	integration.with_overridden_generate(case.module, case.challenge, function()
		...
		assert_test(
			...
			case.lesson_name .. " should apply the first remapped change for " .. case.label
		)
...
local function run_macro_repeat_case(case)
	integration.with_overridden_generate(case.module, case.challenge, function()
		...
		assert_test(
			state.timer_start ~= nil,
			case.lesson_name .. " should start timing on the first actual move for " .. case.label
		)
		...
		assert_test(
			...
			case.lesson_name .. " should apply the recorded edit for " .. case.label
		)
		...
		assert_test(
			...
			case.lesson_name .. " should replay the macro with remapped keys for " .. case.label
		)
		...
		if case.challenge.phases[3] then
			...
			assert_test(
				...
				case.lesson_name .. " should repeat the macro again with remapped @@ for " .. case.label
			)
		end
