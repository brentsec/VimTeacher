...
assert_test(desc_text:find("visual mode") ~= nil or desc_text:find("Visual mode") ~= nil, "Description should mention 'visual mode'")
...
-- Summary
print(string.format("test_intro_visual_mode: %d passed, %d failed (total: %d assertions)",
