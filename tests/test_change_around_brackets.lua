...
assert_test(change_around_brackets.type == "insert", "type must be 'insert', got " .. tostring(change_around_brackets.type))
...
assert_test(#change_around_brackets.allowed_keys == 1, "allowed_keys must have 1 entry, got " .. #change_around_brackets.allowed_keys)
