...
assert_test(
  challenge.start_pos.col < #start_line,
  "start_pos.col out of bounds: " .. challenge.start_pos.col
)
...
for i = 1, 50 do
  ...
  if sl then
    ...
    assert_test(
      sc ~= " " and sc ~= "\t" and sc ~= "",
      "Generation " .. i .. ": start on whitespace/empty at ("
        .. ch.start_pos.row .. "," .. ch.start_pos.col .. ")"
    )
  end
