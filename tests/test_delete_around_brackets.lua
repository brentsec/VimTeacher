...
assert_test(
	delete_around_brackets.type == "insert",
	"type must be 'insert', got " .. tostring(delete_around_brackets.type)
)
...
assert_test(
	#delete_around_brackets.allowed_modify_keys == 1,
	"allowed_modify_keys must have 1 entry, got " .. #delete_around_brackets.allowed_modify_keys
)
