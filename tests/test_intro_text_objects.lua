...
assert_test(
	snippet_text:find("%(") ~= nil or snippet_text:find("%)") ~= nil,
	"sandbox_snippet should contain parentheses"
)
...
assert_test(
	desc_text:find("text object") ~= nil or desc_text:find("Text object") ~= nil,
	"Description should mention 'text object'"
)
...
print(
	string.format(
		"test_intro_text_objects: %d passed, %d failed (total: %d assertions)",
		pass_count,
		fail_count,
