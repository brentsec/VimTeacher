...
assert_test(#quote_text_objects.allowed_keys == 1, "allowed_keys must have 1 entry, got " .. #quote_text_objects.allowed_keys)
...
local valid_keys = {
  ['di"'] = true, ['da"'] = true, ['ci"'] = true, ['ca"'] = true,
  ["di'"] = true, ["da'"] = true, ["ci'"] = true, ["ca'"] = true,
}
assert_test(
...
print(string.format("test_quote_text_objects: %d passed, %d failed", pass_count, fail_count))
