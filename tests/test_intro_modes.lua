...
-- Test 6: Description mentions key mode concepts
local desc_text = table.concat(intro.description, " ")
assert_test(desc_text:find("Normal mode") ~= nil, "Description should mention 'Normal mode'")
assert_test(desc_text:find("Insert mode") ~= nil, "Description should mention 'Insert mode'")
...
-- Summary
print(string.format("test_intro_modes: %d passed, %d failed (total: %d assertions)",
